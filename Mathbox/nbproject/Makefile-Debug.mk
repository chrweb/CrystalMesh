...
${OBJECTDIR}/Geometry_Matrix4x3.o: Geometry_Matrix4x3.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Matrix4x3.o Geometry_Matrix4x3.cpp

${OBJECTDIR}/Geometry_OrientedPlane3D.o: Geometry_OrientedPlane3D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_OrientedPlane3D.o Geometry_OrientedPlane3D.cpp

${OBJECTDIR}/Geometry_Plane3D.o: Geometry_Plane3D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Plane3D.o Geometry_Plane3D.cpp

${OBJECTDIR}/Geometry_Point3D.o: Geometry_Point3D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Point3D.o Geometry_Point3D.cpp

${OBJECTDIR}/Geometry_Vector2D.o: Geometry_Vector2D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Vector2D.o Geometry_Vector2D.cpp

${OBJECTDIR}/Geometry_Vector3D.o: Geometry_Vector3D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Vector3D.o Geometry_Vector3D.cpp

${OBJECTDIR}/Mathbox.o: Mathbox.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mathbox.o Mathbox.cpp
...
${TESTDIR}/Tests/TestMath.o: Tests/TestMath.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -I. -I. -I. -I../gTest -I../gTest/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/Tests/TestMath.o Tests/TestMath.cpp


${TESTDIR}/Tests/TestMatrix4x3.o: Tests/TestMatrix4x3.cpp 
	${MKDIR} -p ${TESTDIR}/Tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -I. -I. -I. -I../gTest -I../gTest/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/Tests/TestMatrix4x3.o Tests/TestMatrix4x3.cpp


${TESTDIR}/Tests/TestPlane3D.o: Tests/TestPlane3D.cpp 
	${MKDIR} -p ${TESTDIR}/Tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -I. -I. -I. -I../gTest -I../gTest/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/Tests/TestPlane3D.o Tests/TestPlane3D.cpp


${TESTDIR}/Tests/TestPoint3D.o: Tests/TestPoint3D.cpp 
	${MKDIR} -p ${TESTDIR}/Tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -I. -I. -I. -I../gTest -I../gTest/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/Tests/TestPoint3D.o Tests/TestPoint3D.cpp


${TESTDIR}/Tests/TestUPL.o: Tests/TestUPL.cpp 
	${MKDIR} -p ${TESTDIR}/Tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -I. -I. -I. -I../gTest -I../gTest/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/Tests/TestUPL.o Tests/TestUPL.cpp


${TESTDIR}/Tests/TestVector3D.o: Tests/TestVector3D.cpp 
	${MKDIR} -p ${TESTDIR}/Tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DDEBUG -I. -I. -I. -I../gTest -I../gTest/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/Tests/TestVector3D.o Tests/TestVector3D.cpp
...
${OBJECTDIR}/Geometry_Matrix4x3_nomain.o: ${OBJECTDIR}/Geometry_Matrix4x3.o Geometry_Matrix4x3.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -w -DDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Matrix4x3_nomain.o Geometry_Matrix4x3.cpp;\
	else  \
...
${OBJECTDIR}/Geometry_OrientedPlane3D_nomain.o: ${OBJECTDIR}/Geometry_OrientedPlane3D.o Geometry_OrientedPlane3D.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -w -DDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_OrientedPlane3D_nomain.o Geometry_OrientedPlane3D.cpp;\
	else  \
...
${OBJECTDIR}/Geometry_Plane3D_nomain.o: ${OBJECTDIR}/Geometry_Plane3D.o Geometry_Plane3D.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -w -DDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Plane3D_nomain.o Geometry_Plane3D.cpp;\
	else  \
...
${OBJECTDIR}/Geometry_Point3D_nomain.o: ${OBJECTDIR}/Geometry_Point3D.o Geometry_Point3D.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -w -DDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Point3D_nomain.o Geometry_Point3D.cpp;\
	else  \
...
${OBJECTDIR}/Geometry_Vector2D_nomain.o: ${OBJECTDIR}/Geometry_Vector2D.o Geometry_Vector2D.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -w -DDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Vector2D_nomain.o Geometry_Vector2D.cpp;\
	else  \
...
${OBJECTDIR}/Geometry_Vector3D_nomain.o: ${OBJECTDIR}/Geometry_Vector3D.o Geometry_Vector3D.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -w -DDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Vector3D_nomain.o Geometry_Vector3D.cpp;\
	else  \
...
${OBJECTDIR}/Mathbox_nomain.o: ${OBJECTDIR}/Mathbox.o Mathbox.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -w -DDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mathbox_nomain.o Mathbox.cpp;\
	else  \
