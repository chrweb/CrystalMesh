...
${OBJECTDIR}/Mathbox.o: Mathbox.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mathbox.o Mathbox.cpp
...
${OBJECTDIR}/Mathbox_nomain.o: ${OBJECTDIR}/Mathbox.o Mathbox.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mathbox_nomain.o Mathbox.cpp;\
	else  \
