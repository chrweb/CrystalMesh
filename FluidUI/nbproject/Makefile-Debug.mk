...
${OBJECTDIR}/CubeView.o: CubeView.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/GL -I/usr/include/FL -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CubeView.o CubeView.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/GL -I/usr/include/FL -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/test.o: test.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/GL -I/usr/include/FL -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test.o test.cpp
...
${OBJECTDIR}/CubeView_nomain.o: ${OBJECTDIR}/CubeView.o CubeView.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/CubeView.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/include/GL -I/usr/include/FL -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CubeView_nomain.o CubeView.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/CubeView.o ${OBJECTDIR}/CubeView_nomain.o;\
	fi
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/include/GL -I/usr/include/FL -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nomain.o main.cpp;\
	else  \
...
${OBJECTDIR}/test_nomain.o: ${OBJECTDIR}/test.o test.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/include/GL -I/usr/include/FL -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_nomain.o test.cpp;\
	else  \
