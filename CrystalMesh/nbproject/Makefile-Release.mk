...
${OBJECTDIR}/AdjacentDirectedEdgeRings.o: AdjacentDirectedEdgeRings.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdjacentDirectedEdgeRings.o AdjacentDirectedEdgeRings.cpp
...
${OBJECTDIR}/EdgeRing.o: EdgeRing.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EdgeRing.o EdgeRing.cpp

${OBJECTDIR}/FacetEdge.o: FacetEdge.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FacetEdge.o FacetEdge.cpp

${OBJECTDIR}/Fan.o: Fan.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Fan.o Fan.cpp

${OBJECTDIR}/Manifold.o: Manifold.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Manifold.o Manifold.cpp
...
${TESTDIR}/TestFiles/f2: ${TESTDIR}/DelaunayTest/DelaunayTriangulation3Test.o ${TESTDIR}/DelaunayTest/TestComplexConstruction.o ${TESTDIR}/DelaunayTest/TestCrater.o ${TESTDIR}/DelaunayTest/TestDelaunayVertex.o ${TESTDIR}/DelaunayTest/TestFan.o ${TESTDIR}/DelaunayTest/TestFlip-1-4.o ${TESTDIR}/DelaunayTest/TestSplitTriangle.o ${TESTDIR}/DelaunayTest/TestTet.o ${TESTDIR}/DelaunayTest/TestTetInteriour.o ${TESTDIR}/DelaunayTest/TestTriangle.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
...
${TESTDIR}/DelaunayTest/TestFlip-1-4.o: DelaunayTest/TestFlip-1-4.cpp 
	${MKDIR} -p ${TESTDIR}/DelaunayTest
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I../gTest -I../gTest/include -pthread -MMD -MP -MF "$@.d" -o ${TESTDIR}/DelaunayTest/TestFlip-1-4.o DelaunayTest/TestFlip-1-4.cpp


${TESTDIR}/DelaunayTest/TestSplitTriangle.o: DelaunayTest/TestSplitTriangle.cpp 
	${MKDIR} -p ${TESTDIR}/DelaunayTest
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I../gTest -I../gTest/include -pthread -MMD -MP -MF "$@.d" -o ${TESTDIR}/DelaunayTest/TestSplitTriangle.o DelaunayTest/TestSplitTriangle.cpp
...
${OBJECTDIR}/AdjacentDirectedEdgeRings_nomain.o: ${OBJECTDIR}/AdjacentDirectedEdgeRings.o AdjacentDirectedEdgeRings.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdjacentDirectedEdgeRings_nomain.o AdjacentDirectedEdgeRings.cpp;\
	else  \
...
${OBJECTDIR}/ComplexConstruction_nomain.o: ${OBJECTDIR}/ComplexConstruction.o ComplexConstruction.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComplexConstruction_nomain.o ComplexConstruction.cpp;\
	else  \
...
${OBJECTDIR}/EdgeRing_nomain.o: ${OBJECTDIR}/EdgeRing.o EdgeRing.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EdgeRing_nomain.o EdgeRing.cpp;\
	else  \
...
${OBJECTDIR}/FacetEdge_nomain.o: ${OBJECTDIR}/FacetEdge.o FacetEdge.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FacetEdge_nomain.o FacetEdge.cpp;\
	else  \
...
${OBJECTDIR}/Fan_nomain.o: ${OBJECTDIR}/Fan.o Fan.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Fan_nomain.o Fan.cpp;\
	else  \
...
${OBJECTDIR}/Manifold_nomain.o: ${OBJECTDIR}/Manifold.o Manifold.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Manifold_nomain.o Manifold.cpp;\
	else  \
