...
${OBJECTDIR}/Domain.o: Domain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Domain.o Domain.cpp
...
${OBJECTDIR}/TetInteriour.o: TetInteriour.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TetInteriour.o TetInteriour.cpp
...
${TESTDIR}/TestFiles/f2: ${TESTDIR}/DelaunayTest/TestCrater.o ${TESTDIR}/DelaunayTest/TestDelaunayVertex.o ${TESTDIR}/DelaunayTest/TestFan.o ${TESTDIR}/DelaunayTest/TestFlip-1-4.o ${TESTDIR}/DelaunayTest/TestSplitTriangle.o ${TESTDIR}/DelaunayTest/TestTet.o ${TESTDIR}/DelaunayTest/TestTetInteriour.o ${TESTDIR}/DelaunayTest/TestTriangle.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
...
${TESTDIR}/DelaunayTest/TestSplitTriangle.o: DelaunayTest/TestSplitTriangle.cpp 
	${MKDIR} -p ${TESTDIR}/DelaunayTest
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -I. -I../gTest -I../gTest/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/DelaunayTest/TestSplitTriangle.o DelaunayTest/TestSplitTriangle.cpp


${TESTDIR}/DelaunayTest/TestTet.o: DelaunayTest/TestTet.cpp 
	${MKDIR} -p ${TESTDIR}/DelaunayTest
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -I. -I../gTest -I../gTest/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/DelaunayTest/TestTet.o DelaunayTest/TestTet.cpp


${TESTDIR}/DelaunayTest/TestTetInteriour.o: DelaunayTest/TestTetInteriour.cpp 
	${MKDIR} -p ${TESTDIR}/DelaunayTest
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -I. -I../gTest -I../gTest/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/DelaunayTest/TestTetInteriour.o DelaunayTest/TestTetInteriour.cpp
...
${OBJECTDIR}/Domain_nomain.o: ${OBJECTDIR}/Domain.o Domain.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Domain_nomain.o Domain.cpp;\
	else  \
...
${OBJECTDIR}/TetInteriour_nomain.o: ${OBJECTDIR}/TetInteriour.o TetInteriour.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TetInteriour_nomain.o TetInteriour.cpp;\
	else  \
