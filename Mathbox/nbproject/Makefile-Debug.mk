...
${OBJECTDIR}/CrystalMesh_Math.o: CrystalMesh_Math.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CrystalMesh_Math.o CrystalMesh_Math.cpp

${OBJECTDIR}/Geometry_Plane3D.o: Geometry_Plane3D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Plane3D.o Geometry_Plane3D.cpp

${OBJECTDIR}/Geometry_Point3D.o: Geometry_Point3D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Point3D.o Geometry_Point3D.cpp

${OBJECTDIR}/Geometry_Vector2D.o: Geometry_Vector2D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Vector2D.o Geometry_Vector2D.cpp

${OBJECTDIR}/Geometry_Vector3D.o: Geometry_Vector3D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Vector3D.o Geometry_Vector3D.cpp
...
${OBJECTDIR}/CrystalMesh_Math_nomain.o: ${OBJECTDIR}/CrystalMesh_Math.o CrystalMesh_Math.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CrystalMesh_Math_nomain.o CrystalMesh_Math.cpp;\
	else  \
...
${OBJECTDIR}/Geometry_Plane3D_nomain.o: ${OBJECTDIR}/Geometry_Plane3D.o Geometry_Plane3D.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Plane3D_nomain.o Geometry_Plane3D.cpp;\
	else  \
...
${OBJECTDIR}/Geometry_Point3D_nomain.o: ${OBJECTDIR}/Geometry_Point3D.o Geometry_Point3D.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Point3D_nomain.o Geometry_Point3D.cpp;\
	else  \
...
${OBJECTDIR}/Geometry_Vector2D_nomain.o: ${OBJECTDIR}/Geometry_Vector2D.o Geometry_Vector2D.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Vector2D_nomain.o Geometry_Vector2D.cpp;\
	else  \
...
${OBJECTDIR}/Geometry_Vector3D_nomain.o: ${OBJECTDIR}/Geometry_Vector3D.o Geometry_Vector3D.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geometry_Vector3D_nomain.o Geometry_Vector3D.cpp;\
	else  \
